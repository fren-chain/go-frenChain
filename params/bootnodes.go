...
import "github.com/fren-chain/go-frenchain/common"
...
// the main FrenTest testnet network.
...
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	return dnsPrefix + protocol + "." + net + ".frenchain.app"
}
