...
import (
	...
	"github.com/fren-chain/go-frenchain/crypto/signify"
	"github.com/fren-chain/go-frenchain/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/fren-chain/go-frenchain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/fren-chain/go-frenchain/mobile")
