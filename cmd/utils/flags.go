...
import (
	...
	"github.com/fren-chain/go-frenchain/accounts"
	"github.com/fren-chain/go-frenchain/accounts/keystore"
	"github.com/fren-chain/go-frenchain/common"
	"github.com/fren-chain/go-frenchain/common/fdlimit"
	"github.com/fren-chain/go-frenchain/consensus"
	"github.com/fren-chain/go-frenchain/consensus/clique"
	"github.com/fren-chain/go-frenchain/consensus/ethash"
	"github.com/fren-chain/go-frenchain/core"
	"github.com/fren-chain/go-frenchain/core/rawdb"
	"github.com/fren-chain/go-frenchain/core/vm"
	"github.com/fren-chain/go-frenchain/crypto"
	"github.com/fren-chain/go-frenchain/eth"
	ethcatalyst "github.com/fren-chain/go-frenchain/eth/catalyst"
	"github.com/fren-chain/go-frenchain/eth/downloader"
	"github.com/fren-chain/go-frenchain/eth/ethconfig"
	"github.com/fren-chain/go-frenchain/eth/gasprice"
	"github.com/fren-chain/go-frenchain/eth/tracers"
	"github.com/fren-chain/go-frenchain/ethdb"
	"github.com/fren-chain/go-frenchain/ethstats"
	"github.com/fren-chain/go-frenchain/graphql"
	"github.com/fren-chain/go-frenchain/internal/ethapi"
	"github.com/fren-chain/go-frenchain/internal/flags"
	"github.com/fren-chain/go-frenchain/les"
	lescatalyst "github.com/fren-chain/go-frenchain/les/catalyst"
	"github.com/fren-chain/go-frenchain/log"
	"github.com/fren-chain/go-frenchain/metrics"
	"github.com/fren-chain/go-frenchain/metrics/exp"
	"github.com/fren-chain/go-frenchain/metrics/influxdb"
	"github.com/fren-chain/go-frenchain/miner"
	"github.com/fren-chain/go-frenchain/node"
	"github.com/fren-chain/go-frenchain/p2p"
	"github.com/fren-chain/go-frenchain/p2p/enode"
	"github.com/fren-chain/go-frenchain/p2p/nat"
	"github.com/fren-chain/go-frenchain/p2p/netutil"
	"github.com/fren-chain/go-frenchain/params"
...
var (
	...
	MainnetFlag = cli.BoolFlag{
		Name:  "mainnet",
		Usage: "FrenChain proof-of-authority mainnet",
	}
	...
	FrenTestFlag = cli.BoolFlag{
		Name:  "frentest",
		Usage: "FrenTest network: proof-of-authority test network",
	}
	FrenChainFlag = cli.BoolFlag{
		Name:  "frenchain",
		Usage: "FrenChain network: proof-of-authority mainnet private network",
	}
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		...
		if ctx.GlobalBool(FrenTestFlag.Name) {
			return filepath.Join(path, "frentest")
		}
		if ctx.GlobalBool(FrenChainFlag.Name) {
			return filepath.Join(path, "frenchain")
		}
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	case ctx.GlobalBool(FrenTestFlag.Name): 
		urls = params.TestnetBootnodes 
	case ctx.GlobalBool(FrenChainFlag.Name): 
		urls = params.MainnetBootnodes 
...
func setDataDir(ctx *cli.Context, cfg *node.Config) {
	...
	case ctx.GlobalBool(FrenTestFlag.Name) && cfg.DataDir == node.DefaultDataDir():
		cfg.DataDir = filepath.Join(node.DefaultDataDir(), "frentest")
	case ctx.GlobalBool(FrenChainFlag.Name) && cfg.DataDir == node.DefaultDataDir():
		cfg.DataDir = filepath.Join(node.DefaultDataDir(), "frenchain")
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	CheckExclusive(ctx, MainnetFlag, DeveloperFlag, RopstenFlag, RinkebyFlag, GoerliFlag, FrenTestFlag, FrenChainFlag, SepoliaFlag)
