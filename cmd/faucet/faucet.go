...
import (
	...
	"github.com/fren-chain/go-frenchain/cmd/utils"
	...
	"github.com/fren-chain/go-frenchain/ethclient"
...
var (
	...
	frenchainFlag  = flag.Bool("frenchain", false, "Initializes the faucet with frenchain mainnet network config")
	frentestFlag  = flag.Bool("frentest", false, "Initializes the faucet with frentest network config")
...
func main() {
	...
	genesis, err := getGenesis(genesisFlag, *goerliFlag, *rinkebyFlag, *frentestFlag, *frenchainFlag)
	if err != nil {
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/fren-chain/go-frenchain/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
...
func getGenesis(genesisFlag *string, goerliFlag bool, rinkebyFlag bool, frentestFlag bool, frenchainFlag bool) (*core.Genesis, error) {
	switch {
